    ...
    return SettingsPage(
      ...
      children: [
        ...
        SettingsGroup(
          ...
          children: [
            // Fork: upstream gates this to non-TV. The fork's TV spotlight
            // backdrop honours the toggle too (see discover_screen's
            // _buildTvContent), so it stays available on TV.
            SettingSwitchTile(
